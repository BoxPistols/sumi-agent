...
export const REGEX_PATTERNS: RegexPattern[] = [
  ...
  },
  {
    ...
    label: 'Qiitaアカウント',
    category: 'contact',
    regex: /(?:Qiita|qiita|キータ)\s*[：:・\s]\s*@?([a-zA-Z0-9_-]{1,30})/gi,
    group: 1,
  },
  {
    id: 'sns_zenn',
    label: 'Zennアカウント',
    category: 'contact',
    regex: /(?:Zenn|zenn)\s*[：:・\s]\s*@?([a-zA-Z0-9_-]{1,30})/gi,
    group: 1,
  },
  {
    id: 'sns_note',
  ...
  },
  {
    ...
    label: 'Dribbbleアカウント',
    category: 'contact',
    regex: /(?:Dribbble|dribbble|Dribble|ドリブル)\s*[：:・\s]\s*@?([a-zA-Z0-9_-]{1,30})/gi,
    group: 1,
  },
  {
    id: 'sns_behance',
    label: 'Behanceアカウント',
    category: 'contact',
    regex: /(?:Behance|behance|ビハンス)\s*[：:・\s]\s*@?([a-zA-Z0-9_-]{1,30})/gi,
    group: 1,
  },
  {
    id: 'sns_youtube',
    label: 'YouTubeアカウント',
    category: 'contact',
    regex: /(?:YouTube|Youtube|youtube|ユーチューブ)\s*[：:・\s]\s*@?([a-zA-Z0-9_.-]{1,50})/gi,
    group: 1,
  },
  {
    id: 'sns_tiktok',
    label: 'TikTokアカウント',
    category: 'contact',
    regex: /(?:TikTok|tiktok|ティックトック)\s*[：:・\s]\s*@([a-zA-Z0-9_.]{1,24})/gi,
    group: 1,
  },
  {
    id: 'sns_threads',
    label: 'Threadsアカウント',
    category: 'contact',
    regex: /(?:Threads|threads|スレッズ)\s*[：:・\s]\s*@([a-zA-Z0-9_.]{1,30})/gi,
    group: 1,
  },
  {
    id: 'sns_bluesky',
    label: 'Blueskyアカウント',
    category: 'contact',
    regex: /(?:Bluesky|bluesky|bsky|ブルースカイ)\s*[：:・\s]\s*@?([a-zA-Z0-9_.-]{1,50})/gi,
    group: 1,
  },
  {
    id: 'sns_mastodon',
    label: 'Mastodonアカウント',
    category: 'contact',
    regex: /(?:Mastodon|mastodon|マストドン)\s*[：:・\s]\s*@?([a-zA-Z0-9_]+(?:@[a-zA-Z0-9.-]+)?)/gi,
    group: 1,
  },
  {
    id: 'sns_pinterest',
    label: 'Pinterestアカウント',
    category: 'contact',
    regex: /(?:Pinterest|pinterest|ピンタレスト)\s*[：:・\s]\s*@?([a-zA-Z0-9_-]{1,30})/gi,
    group: 1,
  },
  {
    id: 'sns_wantedly',
    label: 'Wantedlyアカウント',
    category: 'contact',
    regex: /(?:Wantedly|wantedly|ウォンテッドリー)\s*[：:・\s]\s*@?([a-zA-Z0-9_-]{1,50})/gi,
    group: 1,
  },
  {
    id: 'sns_connpass',
    label: 'connpassアカウント',
    category: 'contact',
    regex: /(?:connpass|Connpass)\s*[：:・\s]\s*@?([a-zA-Z0-9_-]{1,30})/gi,
    group: 1,
  },
  {
    id: 'sns_line',
  ...
  },
  {
    ...
    label: 'Discordアカウント',
    category: 'contact',
    regex: /(?:Discord|discord|ディスコード)\s*[：:・\s]\s*@?([a-zA-Z0-9_.#]{2,37})/gi,
    group: 1,
  },
  {
    id: 'sns_slack',
    label: 'Slackアカウント',
    category: 'contact',
    regex: /(?:Slack|slack|スラック)\s*[：:・\s]\s*@?([a-zA-Z0-9_.-]{1,30})/gi,
    group: 1,
  },
  {
    id: 'sns_medium',
    label: 'Mediumアカウント',
    category: 'contact',
    regex: /(?:Medium|medium)\s*[：:・\s]\s*@([a-zA-Z0-9_.-]{1,30})/gi,
    group: 1,
  },
  {
  ...
  {
    id: 'sns_speakerdeck',
    label: 'Speaker Deckアカウント',
    category: 'contact',
    regex: /(?:Speaker\s*Deck|speakerdeck)\s*[：:・\s]\s*@?([a-zA-Z0-9_-]{1,30})/gi,
    group: 1,
  },
]
