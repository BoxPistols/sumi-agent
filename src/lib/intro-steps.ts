 ...
 * intro.js ステップ定義
 *
 * Sumi のオンボーディングガイドツアーのステップを管理する。
...
export const UPLOAD_STEPS_LITE: IntroStep[] = [
  STEP_FLOW_INTRO,
  {
    ...
    title: 'ファイルアップロード',
    intro:
      'ファイルをドラッグ＆ドロップ、またはクリックして選択。PDF、Word、Excelなど多数の形式に対応しています。',
    position: 'bottom',
  },
  {
...
export const PREVIEW_MODAL_STEPS: IntroStep[] = [
  {
    ...
    title: '表示切替',
    intro:
      '「レイアウト」で書式付きプレビュー、「テキスト」でプレーンテキスト、「編集」で直接編集できます。',
    position: 'bottom',
  },
  {
    ...
    title: '出力形式',
    intro:
      'Text・Markdown・CSV・Excel・PDF（印刷）・Wordの6形式から選択。形式を切り替えるとプレビューも変わります。',
    position: 'top',
  },
  {
...
export const PRO_SWITCH_STEPS: IntroStep[] = [
  ...
  },
  {
    element: '[data-intro="settings-button"]',
    title: 'AI設定',
    intro: 'AI検出プロバイダ（OpenAI / ローカルAI）の設定やAPIキーの管理。',
    position: 'bottom',
  },
]
