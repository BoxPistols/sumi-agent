...
describe('統合テスト: 検出カバレッジ', () => {
  describe('01_ITエンジニア', () => {
    let dets: Det[]
    beforeAll(() => {
      dets = detectAll(loadMock('01_職務経歴書_ITエンジニア.txt'))
    })
  ...
  describe('02_事務職', () => {
    let dets: Det[]
    beforeAll(() => {
      dets = detectAll(loadMock('02_履歴書_事務職.txt'))
    })
  ...
  describe('06_英文レジュメ', () => {
    let dets: Det[]
    beforeAll(() => {
      dets = detectAll(loadMock('06_英文レジュメ_PM.txt'))
    })
  ...
  describe('10_外国人（日本語）', () => {
    let dets: Det[]
    beforeAll(() => {
      dets = detectAll(loadMock('10_職務経歴書_外国人_日本語.txt'))
    })
  ...
  describe('15_社員名簿CSV', () => {
    let dets: Det[]
    beforeAll(() => {
      dets = detectAll(loadMock('15_社員名簿_CSV形式.txt'))
    })
  ...
  describe('16_介護福祉士', () => {
    let dets: Det[]
    beforeAll(() => {
      dets = detectAll(loadMock('16_職務経歴書_介護福祉士.txt'))
    })
